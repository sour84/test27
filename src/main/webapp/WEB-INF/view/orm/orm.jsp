...
<page:template>
    <jsp:body>
        ...
        <c:url value=" " var="queryFindByIdUser" />
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <table>
                        ...
                        <tr>
                                <td>
                                <c:out value="${listValue.firstName}"/>
                            </td>
                                <td>
                                    <c:out value="${listValue.lastName}"/>
                                </td>
                                <td>
                                    <c:out value="${listValue.birthDate}"/>
                                </td>
                            </c:forEach>
                        </tr>
                    </table>
            ...
            <spring:form modelAttribute="userFromServer" method="post" action="/queryFindByIdUser/1">
                <spring:input path="loggin"/>
                <spring:input path="password"/>
                <spring:button>check user</spring:button>
            </spring:form>
                    <%--<h1>Car List</h1>--%>

                    <%--<c:forEach items="${resultObject}" var="car">--%>
